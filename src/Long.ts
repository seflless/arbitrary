 ...
 * @private
 */
const TWO_PWR_16_DBL_ = 1 << 16;

/**
 * @type {number}
 * @private
 */
const TWO_PWR_32_DBL_ = TWO_PWR_16_DBL_ * TWO_PWR_16_DBL_;

/**
 * @type {number}
 * @private
 */
const TWO_PWR_64_DBL_ = TWO_PWR_32_DBL_ * TWO_PWR_32_DBL_;

/**
 * @type {number}
 * @private
 */
const TWO_PWR_63_DBL_ = TWO_PWR_64_DBL_ / 2;
...
class Long {
  ...
  toNumber() {
    return this.#high * TWO_PWR_32_DBL_ + this.getLowBitsUnsigned();
  }
  ...
  getLowBitsUnsigned() {
    return this.#low >= 0 ? this.#low : TWO_PWR_32_DBL_ + this.#low;
  }
  ...
  multiply(other: Long): Long {
    ...
    if (
      this.lessThan(Long.getTwoPwr24()) &&
   ...
   *     zeros placed into the new leading bits.
   */
  shiftRightUnsigned(numBits: number) {
    numBits &= 63;
    if (numBits == 0) {
      return this;
    } else {
